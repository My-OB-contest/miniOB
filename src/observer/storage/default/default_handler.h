...
public:
   ...
   * @return
   */
  RC create_index(Trx *trx, const char *dbname, const char *relation_name, const char *index_name, char *const *attribute_name,int attr_num,int isunique);
   ...
   * @return
   */
  RC insert_record(Trx * trx, const char *dbname, const char *relation_name, const size_t value_num[], const Value values[][MAX_NUM], int value_list_length);
